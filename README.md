...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tiptop-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14924&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tiptop-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tiptop` can be installed with:

```
conda install tiptop
```

It is possible to list all of the versions of `tiptop` available on your platform with:
